...
public class ModifierPatientForm extends javax.swing.JFrame
{
     ...
     * @param mainFrame
     */
    public ModifierPatientForm(MedecinForm mainFrame)
    {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTF_Nom2)
                            .addComponent(jTF_Nom1))))
                .addGap(80, 80, 80))
            .addGroup(layout.createSequentialGroup()
                .addGap(110, 110, 110)
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ModifierPatientForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new ModifierPatientForm(null).setVisible(true);
            }
        });
    }
