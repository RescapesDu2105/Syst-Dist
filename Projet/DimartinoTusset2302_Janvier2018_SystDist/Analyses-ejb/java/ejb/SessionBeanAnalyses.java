    ...
    public HashMap<Demande, ArrayList<Analyses>> getAllResultatsAnalysesByPatient(Patient patient, boolean urgent)
    {
        ...
        try
        {
            if(urgent)
                ...
                Demandes = new ArrayList<>(em.createQuery("SELECT d FROM Demande d WHERE d.refPatient = :patient AND d.resultatsDisponibles = true").setParameter("patient", patient).getResultList());
