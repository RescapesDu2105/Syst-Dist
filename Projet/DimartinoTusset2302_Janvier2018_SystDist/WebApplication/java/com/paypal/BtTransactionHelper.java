...
public class BtTransactionHelper {
	...
	public void doTransactionEc(BtParameterVo vo) {
		...
		try {	
			...
			TransactionRequest transactionRequest = new TransactionRequest()
				...
				.options()
					.paypal()
						.customField("Custom field message")
	...
	private void logPayPalDetails(Result<Transaction> result) {
		System.out.println("result.getTarget().getPaymentInstrumentType(): " + result.getTarget().getPaymentInstrumentType());
		System.out.println("result.getTarget().getPayPalDetails().getCaptureId(): " + result.getTarget().getPayPalDetails().getCaptureId());	
		System.out.println("result.getTarget().getPayPalDetails().getPaymentId(): " + result.getTarget().getPayPalDetails().getPaymentId());		
		System.out.println("result.getTarget().getPayPalDetails().getPayerFirstName(): " + result.getTarget().getPayPalDetails().getPayerFirstName());
		System.out.println("result.getTarget().getPayPalDetails().getPayerLastName(): " + result.getTarget().getPayPalDetails().getPayerLastName());		
	}
